...
/// </summary>
public class GamePrefsAccessor<ValueT> 
{
    private PrefAccessor<ValueT> accessor;

    /// <summary>
    /// Create a GamePrefsAccessor from a PrefAccessor which can read and write the desired type.
    /// Already setup GamePrefsAccessors for the main types are available through the GamePrefs class.
    /// </summary>
    /// <param name="accessor">The PlayerPrefs accessor for the desired type.</param>
    public GamePrefsAccessor(PrefAccessor<ValueT> accessor) 
    {
    ...
    /// <summary>
    /// Retrieve a GamePrefsValue which will allow you to get and set to and from a particular key in PlayerPrefs.
    /// </summary>
    /// <param name="prefKey">The PlayerPrefs key.</param>
    /// <returns>A class to access value for a particular PlayerPrefs key.</returns>
    public GamePrefsKeyAccessor<ValueT> KeyAccessor(string prefKey)
    {
        return new GamePrefsKeyAccessor<ValueT>(this, prefKey);
    }
